...
class LuckyDrawScreen extends GetWidget<LuckyDrawController> {
  @override
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: SvgPicture.asset(ImageConstant.imgGroup416, fit: BoxFit.fill)))
                                                                  ])),
                                                          Padding(
                                                              padding: EdgeInsets.only(
                                                                  top: getVerticalSize(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Container(
                                                                            height:
                                                                                getSize(24.02),
                                                                            width: getSize(24.02),
                                                                            child: SvgPicture.asset(ImageConstant.imgCardinfo1, fit: BoxFit.fill))))
                                                              ]))
                                                    ])),
                                            Padding(
                                                padding: EdgeInsets.only(
                                                                  ...
                                                                  child: Stack(
                                                                      children: [
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.center,
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(8.00), top: getVerticalSize(8.00), right: getHorizontalSize(8.00), bottom: getVerticalSize(8.00)), child: Container(height: getSize(24.00), width: getSize(24.00), child: SvgPicture.asset(ImageConstant.imgSolidinterface35, fit: BoxFit.fill))))
                                                                      ]))),
                                                          Container(
                                                              height: getSize(
                                                                  40.00),
                                                                  ...
                                                                  child: Stack(
                                                                      children: [
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.center,
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(8.00), top: getVerticalSize(8.00), right: getHorizontalSize(8.00), bottom: getVerticalSize(8.00)), child: Container(height: getSize(24.00), width: getSize(24.00), child: SvgPicture.asset(ImageConstant.imgOutlinefilesd3, fit: BoxFit.fill))))
                                                                      ]))),
                                                          Container(
                                                              height: getSize(
                                                                  40.00),
                                                                  ...
                                                                  child: Stack(
                                                                      children: [
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.center,
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(8.00), top: getVerticalSize(8.00), right: getHorizontalSize(8.00), bottom: getVerticalSize(8.00)), child: Container(height: getSize(24.00), width: getSize(24.00), child: SvgPicture.asset(ImageConstant.imgSolidinterface36, fit: BoxFit.fill))))
                                                                      ]))),
                                                          Container(
                                                              height: getSize(
                                                                  40.00),
                                                                  ...
                                                                  child: Stack(
                                                                      children: [
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.center,
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(8.00), top: getVerticalSize(8.00), right: getHorizontalSize(8.00), bottom: getVerticalSize(8.00)), child: Container(height: getSize(24.00), width: getSize(24.00), child: SvgPicture.asset(ImageConstant.imgOutlinefilesi1, fit: BoxFit.fill))))
                                                                      ])))
                                                        ])),
                                                Padding(
                                                    padding: EdgeInsets.only(
                                                                  ...
                                                                  children: [
                                                                    Align(
                                                                        ...
                                                                        child: Padding(
                                                                            ...
                                                                            child: Container(height: getVerticalSize(25.11), width: getHorizontalSize(24.00), child: SvgPicture.asset(ImageConstant.imgSolidstatusin1, fit: BoxFit.fill)))),
                                                                    Align(
                                                                        alignment:
                                                                            Alignment
                                                                                .centerLeft,
                                                                            ...
                                                                            child: Stack(alignment: Alignment.topRight, children: [
                                                                              Align(
                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      child: RichText(
                                                                                          text: TextSpan(children: [
                                                                                            TextSpan(text: "lbl_lucky_draw".tr, style: TextStyle(color: ColorConstant.whiteA700, fontSize: getFontSize(20), fontFamily: 'Plus Jakarta Sans', fontWeight: FontWeight.w600)),
                                                                                            TextSpan(text: "msg_you_have_8_off".tr, style: TextStyle(color: ColorConstant.whiteA700, fontSize: getFontSize(16), fontFamily: 'Plus Jakarta Sans', fontWeight: FontWeight.w400))
                                                                                          ]),
                                                                                          textAlign: TextAlign.left))),
                                                                              Align(alignment: Alignment.topRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), right: getHorizontalSize(7.00), bottom: getVerticalSize(10.00)), child: Container(height: getSize(63.00), width: getSize(63.00), child: SvgPicture.asset(ImageConstant.imgOutlinestatus2, fit: BoxFit.fill))))
                                                                            ]))),
                                                                    Align(
                                                                        alignment:
                                                                            Alignment
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: SmoothIndicator(offset: 0, count: 3, axisDirection: Axis.horizontal, effect: ScrollingDotsEffect(spacing: 10, activeDotColor: ColorConstant.black900, dotColor: ColorConstant.bluegray100, dotHeight: getVerticalSize(8.00), dotWidth: getHorizontalSize(8.00)))))
                                                                  ])))
                                                    ]))
                                          ])),
                                  Container(
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Container(
                                                                            height:
                                                                                getSize(46.00),
                                                                            width: getSize(46.00),
                                                                            child: SvgPicture.asset(ImageConstant.imgApple1, fit: BoxFit.fill)))
                                                                  ])),
                                                          Padding(
                                                              padding: EdgeInsets.only(
                                                                  left:
                                                                              ...
                                                                              Container(
                                                                                  ...
                                                                                  child: Card(
                                                                                      ...
                                                                                      child: Stack(children: [
                                                                                        Align(alignment: Alignment.center, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(9.00), top: getVerticalSize(9.00), right: getHorizontalSize(9.00), bottom: getVerticalSize(9.00)), child: Image.asset(ImageConstant.imgNetflix1, height: getSize(22.00), width: getSize(22.00), fit: BoxFit.fill)))
                                                                                      ]))),
                                                                              Container(
                                                        ...
                                                        child: FloatingActionButton(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    child: SvgPicture.asset(ImageConstant.imgGroup282))))),
                                                    Padding(
                                                        padding: EdgeInsets.only(
                                                            top:
                                                                getVerticalSize(
                                                                  ...
                                                                  child: Padding(
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          width: getSize(
                                                                              24.00),
                                                                          child: SvgPicture.asset(
                                                                              ImageConstant.imgSolidinterface37,
                                                                              fit: BoxFit.fill)))),
                                                              Padding(
                                                                  padding: EdgeInsets.only(
                                                                      top: getVerticalSize(
